...
export type MutationRemoveStatisticsArgs = {
  data: IdInput;
};
...
export type FetchMeQuery = { __typename?: 'Query', me: { __typename?: 'Member', id: string, username: string, email: string, isAdmin: boolean } };
...
export type FetchMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, username: string, fullName: string, email: string, address: string, assetId: string, mobile: string, payoutId: string, isAdmin: boolean, wallet: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, payout: { __typename?: 'Payout', id: string, name: string, status: boolean, method: string, display: string } } | null> | null } };
...
export type FetchMemberStatisticsQuery = { __typename?: 'Query', memberStatistics: { __typename?: 'MemberStatisticsResponse', total?: number | null, memberStatistics?: Array<{ __typename?: 'MemberStatistics', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, statisticsId: string, txcShared: number, hashPower: number, percent: number, issuedAt: any, member?: { __typename?: 'Member', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, username: string, fullName: string, email: string, mobile: string, assetId: string, payoutId: string, isAdmin: boolean, wallet: string, address: string, payout: { __typename?: 'Payout', id: string, name: string, status: boolean, method: string, display: string } } | null, statistics?: { __typename?: 'Statistics', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, newBlocks: number, totalBlocks: number, totalHashPower: number, totalMembers: number, status: boolean, txcShared: number, issuedAt: any, from: any, to: any } | null } | null> | null } };
...
export type FetchSalesQuery = { __typename?: 'Query', sales: { __typename?: 'SalesResponse', total?: number | null, sales?: Array<{ __typename?: 'Sale', id: string, invoiceNo: number, memberId: string, packageId: string, paymentMethod: string, orderedAt: any, status: boolean, member?: { __typename?: 'Member', id: string, username: string, fullName: string, email: string, mobile: string, assetId: string, address: string, payoutId: string, isAdmin: boolean, wallet: string, payout: { __typename?: 'Payout', id: string, name: string, status: boolean, method: string, display: string } } | null, package?: { __typename?: 'Package', id: string, productName: string, amount: number, date: any, token: number, status: boolean } | null } | null> | null } };
